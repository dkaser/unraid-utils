...
class Utils
{
    ...
    */
    ...
    /**
     * Return an HTML block containing GPLv3 license text, formatted for the Unraid GUI.
     */
    public function getLicenseBlock(): string
    {
        return <<<EOD
            ...
            <p><a href="/plugins/{$this->pluginName}/LICENSE.txt" rel="noopener noreferrer" target="_blank">View License File</a></p>
            EOD;
    }
}
